...
namespace BooksPlant.Controllers
{
    public class StreamingController : Controller
    {
        ...
        private readonly string[] _permittedExtensions = { ".pdf", ".png", ".jpg"};
                    ...
                    else
                    {
                        ...
                        try
                        {
                            using (var targetStream = System.IO.File.Create(
                                Path.Combine(_targetFilePath, trustedFileNameForFileStorage + Path.GetExtension(contentDisposition.FileName.Value).ToLowerInvariant())))
                            {
